        ...
        t.fn.extend({
            effect: function() {
                function i(e) {
                    ...
                    var r = t(this);
                    s.mode = u.shift(),
                    t.uiBackCompat === !1 || o ? "none" === s.mode ? (r[c](),
                    a()) : n.call(r[0], s, i) : (r.is(":hidden") ? "hide" === c : "show" === c) ? (r[c](),
                    a()) : n.call(r[0], s, a)
                }
...
function dle_change_sort(e, o) {
    ...
    return t.dlenewssortby.value = e,
    t.dledirection.value = o,
    t.submit(),
    !1
}
function doPoll(e, o) {
...
function IPMenu(e, o, t, i) {
    var n = [];
    return n[0] = '<a href="https://www.nic.ru/whois/?searchWord=' + e + '" target="_blank">' + o + "</a>",
...
function ajax_prep_for_edit(d, l) {
    for (var e = 0, o = c_cache.length; e < o; e++)
...
function ajax_comm_edit(o, e) {
    for (var t = 0, i = c_cache.length; t < i; t++)
        t in c_cache && "" != c_cache[t] && ajax_cancel_comm_edit(t);
    return c_cache[o] && "" != c_cache[o] || (c_cache[o] = $("#comm-id-" + o).html()),
    ShowLoading(""),
...
function doFavorites(o, e, t) {
    ...
    $.get(dle_root + "engine/ajax/controller.php?mod=favorites", {
        ...
        HideLoading(""),
        t ? DLEalert(e, dle_info) : $("#fav-id-" + o).html(e)
    }),
    !1
}
function CheckLogin() {
...
function doRate(e, t) {
    ...
    $.get(dle_root + "engine/ajax/controller.php?mod=rating", {
        ...
        var o;
        HideLoading(""),
        e.success ? (o = (o = (o = (o = e.rating).replace(/&lt;/g, "<")).replace(/&gt;/g, ">")).replace(/&amp;/g, "&"),
        $("#ratig-layer-" + t).html(o),
        $("#vote-num-id-" + t).html(e.votenum),
        $("#likes-id-" + t).html(e.likes),
        $("#dislikes-id-" + t).html(e.dislikes)) : e.error && DLEalert(e.errorinfo, dle_info)
    }, "json")
}
function doCommentsRate(e, t) {
    ...
    $.get(dle_root + "engine/ajax/controller.php?mod=ratingcomments", {
        ...
        $("#comments-dislikes-id-" + t).html(e.dislikes)) : e.error && DLEalert(e.errorinfo, dle_info)
    }, "json")
}
...
function DLESendPM(e) {
    ...
    o[dle_p_send] = function() {
        ...
        var e = $("#pm_subj").val()
          ...
          , l = "";
        return "" == t ? DLEalert(dle_req_field[0], dle_info) : "" == o ? DLEalert(dle_req_field[1], dle_info) : "" == e ? DLEalert(dle_req_field[2], dle_info) : ("1" == dle_captcha_type ? "undefined" != typeof grecaptcha && (l = grecaptcha.getResponse(recaptcha_widget)) : "2" == dle_captcha_type && (l = $("#pm-recaptcha-response").val()),
        d = d || 0,
        n = n || "",
        i = i || "",
        ShowLoading(""),
        $.post(dle_root + "engine/ajax/controller.php?mod=pm", {
            ...
            DLEalert(e.success, dle_info)) : e.error && ("2" == dle_captcha_type && "undefined" != typeof grecaptcha && (o = $("#pm-recaptcha-response").data("key"),
...
function ajax_fast_reply(e, o, t) {
    ...
    var n = $("#comments" + e).val()
      ...
      , r = $("#postid" + e).val()
      , c = "";
    return "" == d ? DLEalert(dle_req_field[0], dle_info) : "" == n ? DLEalert(dle_req_field[1], dle_info) : ("1" == dle_captcha_type ? "undefined" != typeof grecaptcha && (c = grecaptcha.getResponse(recaptcha_widget)) : "2" == dle_captcha_type && (c = $("#comments-recaptcha-response" + e).val()),
    s = s || 0,
    a = a || "",
    l = l || "",
    ShowLoading(""),
    $.post(dle_root + "engine/ajax/controller.php?mod=addcomments", {
        ...
        $("html,body").stop().animate({
            ...
            $("#comm-id-" + e.id).fadeOut("slow", function() {
                $(this).html(o + "<script>" + e.scripts + "<\/script>"),
...
function dle_reply(s, r, o) {
    ...
    $("#comment-id-" + s).next(".comments-tree-list").length ? $("#comment-id-" + s).next(".comments-tree-list").append("<div id='dlefastreplyesponse'></div>") : ($("<div id='dlefastreplyesponse'></div>").insertAfter("#comment-id-" + s),
    p = 1),
    ...
    t[dle_p_send] = function() {
        ...
        var e = $("#comments" + s).val()
          ...
          , l = $("#postid" + s).val()
          , a = "";
        return "" == o ? DLEalert(dle_req_field[0], dle_info) : "" == e ? DLEalert(dle_req_field[1], dle_info) : ("1" == dle_captcha_type ? "undefined" != typeof grecaptcha && (a = grecaptcha.getResponse(recaptcha_widget)) : "2" == dle_captcha_type && (a = $("#comments-recaptcha-response" + s).val()),
        d = d || 0,
        n = n || "",
        i = i || "",
        ShowLoading(""),
    ...
    $.get(dle_root + "engine/ajax/controller.php?mod=replycomments", {
        ...
        HideLoading(""),
        "0" != o ? ($("<div id='dlefastreplycomments' style='display:none'></div>").insertAfter("#comment-id-" + s),
        $("html,body").stop().animate({
            scrollTop: $("#comment-id-" + s).offset().top + $("#comment-id-" + s).height() - 100
        }, 600, function() {
...
function doAddComments() {
    ...
    e = "wysiwyg"),
    "" == i.name.value ? DLEalert(dle_req_field[0], dle_info) : "" == i.comments.value ? DLEalert(dle_req_field[1], dle_info) : (i.question_answer && (o = i.question_answer.value),
    ...
    $.post(dle_root + "engine/ajax/controller.php?mod=addcomments", {
        ...
        var o, t;
        HideLoading(""),
        e.error ? $("#dle-ajax-comments").append(e.content) : e.success && ($("#comm-id-" + e.id).length ? (o = $(e.content).find("#comm-id-" + e.id).html(),
        $("html,body").stop().animate({
            scrollTop: $("#comm-id-" + e.id).offset().top - 100
        }, 600, function() {
            $("#comm-id-" + e.id).fadeOut("slow", function() {
        ...
        i.sec_code && (i.sec_code.value = "",
        reload()),
        "1" == dle_captcha_type ? "undefined" != typeof grecaptcha && grecaptcha.reset() : "2" == dle_captcha_type && "undefined" != typeof grecaptcha && (t = $("#g-recaptcha-response").data("key"),
...
function CommentsPage(o, t, i) {
    ...
    $.get(dle_root + "engine/ajax/controller.php?mod=comments", {
        ...
        HideLoading(""),
        isNaN(o) || isNaN(t) || ($("#dle-comm-link").off("click"),
        $("#dle-comm-link").on("click", function() {
            return CommentsPage(o, t),
            !1
        })),
...
function dle_copy_quote(e) {
    ...
    "1" == dle_wysiwyg ? '<div class="quote_block noncontenteditable"><div class="title_quote">' + dle_quote_title + " " + e + '</div><div class="quote"><div class="quote_body contenteditable">' + dle_txt + "</div></div></div><br>" : '<div class="quote_block noncontenteditable"><div class="title_quote">' + dle_quote_title + " " + e + '</div><div class="quote"><div class="quote_body contenteditable">' + dle_txt + "</div></div></div><p><br></p>"))
}
function dle_fastreply(e) {
    if (!document.getElementById("dle-comments-form"))
        return !1;
    var o, t = document.getElementById("dle-comments-form").comments, i = "";
    return "0" == dle_wysiwyg || "-1" == dle_wysiwyg ? ("0" == dle_wysiwyg ? t.value += "[b]" + e + "[/b],\n" : t.value += e + ",\n",
    setTimeout(function() {
        t.focus()
    }, 800),
    i = ".bb-editor") : (o = "<div><b>" + e + "</b>,</div><br>",
    i = ".wseditor",
    "1" == dle_wysiwyg ? ($("#comments").froalaEditor("events.focus"),
    $("#comments").froalaEditor("html.insert", o, !0)) : tinyMCE.execCommand("mceInsertContent", !1, o)),
    setTimeout(function() {
        $("html,body").stop().animate({
...
function dle_ins(e) {
    ...
    i = ".bb-editor") : (t = dle_txt,
    i = ".wseditor",
    "1" == dle_wysiwyg ? ($("#comments").froalaEditor("events.focus"),
    $("#comments").froalaEditor("html.insert", t, !0)) : tinyMCE.execCommand("mceInsertContent", !1, t)),
    setTimeout(function() {
        $("html,body").stop().animate({
            scrollTop: $(i).offset().top - 100
        }, 700)
    ...
    $.get(dle_root + "engine/ajax/controller.php?mod=quote", {
        ...
        "0" == dle_wysiwyg || "-1" == dle_wysiwyg ? (o.value += e + "\n",
        setTimeout(function() {
            o.focus()
        }, 800),
        i = ".bb-editor") : (t = e,
        i = ".wseditor",
        "1" == dle_wysiwyg ? ($("#comments").froalaEditor("events.focus"),
        $("#comments").froalaEditor("html.insert", t + "<br>", !0)) : tinyMCE.execCommand("mceInsertContent", !1, t + "<p><br></p>")),
        setTimeout(function() {
            $("html,body").stop().animate({
                scrollTop: $(i).offset().top - 100
            }, 700)
...
function ShowOrHide(e) {
    var o = $("#" + e)
      , t = null;
    document.getElementById("image-" + e) && (t = document.getElementById("image-" + e)),
    jQuery().lazyLoadXT && $("#" + e + " *[data-src]").lazyLoadXT();
    e = o.height() / 200 * 1e3;
    3e3 < e && (e = 3e3),
    e < 250 && (e = 250),
    "none" == o.css("display") ? (o.show("blind", {}, e),
    t && (t.src = dle_root + "templates/" + dle_skin + "/dleimages/spoiler-minus.gif")) : (2e3 < e && (e = 2e3),
    o.hide("blind", {}, e),
    t && (t.src = dle_root + "templates/" + dle_skin + "/dleimages/spoiler-plus.gif"))
}
...
function dle_news_delete(o) {
    ...
    e[dle_act_lang[0]] = function() {
        $(this).dialog("close"),
        document.location = dle_root + "index.php?do=deletenews&id=" + o + "&hash=" + dle_login_hash
    }
    ,
    $("#dlepopup").remove(),
...
function MenuNewsBuild(e, o) {
    var t = [];
    return t[0] = "<a onclick=\"ajax_prep_for_edit('" + e + "', '" + o + '\'); return false;" href="#">' + menu_short + "</a>",
    "" != dle_admin && (t[1] = '<a href="' + dle_root + dle_admin + "?mod=editnews&action=editnews&id=" + e + '" target="_blank">' + menu_full + "</a>"),
    allow_dle_delete_news && (t[2] = "<a onclick=\"sendNotice ('" + e + '\'); return false;" href="#">' + dle_notice + "</a>",
    t[3] = "<a onclick=\"dle_news_delete ('" + e + '\'); return false;" href="#">' + dle_del_news + "</a>"),
    t
}
...
function AddComplaint(t, i) {
    ...
    $("body").append("<div id='dlepopup' title='" + dle_c_title + "' style='display:none'>" + dle_complaint + "<br><textarea name='dle-promt-text' id='dle-promt-text' class='ui-widget-content ui-corner-all' style='width:100%;height:100px;'></textarea>" + o + "</div>"),
    $("#dlepopup").dialog({
        autoOpen: !0,
        width: 600,
        resizable: !1,
...
function DLEalert(e, o) {
    $("#dlepopup").remove(),
    $("body").append("<div id='dlepopup' class='dle-alert' title='" + o + "' style='display:none'>" + e + "</div>"),
    $("#dlepopup").dialog({
        autoOpen: !0,
        width: 470,
        resizable: !1,
...
function DLEconfirm(e, o, t) {
    ...
    ,
    $("#dlepopup").remove(),
    $("body").append("<div id='dlepopup' class='dle-confirm' title='" + o + "' style='display:none'>" + e + "</div>"),
    $("#dlepopup").dialog({
        autoOpen: !0,
        width: 500,
        resizable: !1,
...
function DLEprompt(e, o, t, i, n) {
    ...
    d[dle_act_lang[2]] = function() {
        var e;
        !n && $("#dle-promt-text").val().length < 1 ? $("#dle-promt-text").addClass("ui-state-error") : (e = $("#dle-promt-text").val(),
        $(this).dialog("close"),
        $("#dlepopup").remove(),
        i && i(e))
    }
    ,
    $("#dlepopup").remove(),
    $("body").append("<div id='dlepopup' class='dle-promt' title='" + t + "' style='display:none'>" + e + "<br /><br /><input type='text' name='dle-promt-text' id='dle-promt-text' class='ui-widget-content ui-corner-all' style='width:97%;' value='" + o + "'/></div>"),
    $("#dlepopup").dialog({
        autoOpen: !0,
        width: 500,
        resizable: !1,
    ...
    (0 < o.length ? $("#dle-promt-text").select() : $("#dle-promt-text")).focus()
}
...
function ShowLoading(e) {
    ...
    e ? $("#loading-layer").html(e) : $("#loading-layer").html(dle_act_lang[6]);
...
function media_upload(e, o, t, i) {
    ...
    $.get(dle_root + "engine/ajax/controller.php", {
        ...
        $("#mediaupload").dialog({
            ...
            dragStart: function(e, o) {
                n = $(".modalfixed").css("box-shadow"),
                $(".modalfixed").fadeTo(0, .7).css("box-shadow", "none"),
                $("#mediaupload").css("visibility", "hidden")
            },
            dragStop: function(e, o) {
                $(".modalfixed").fadeTo(0, 1).css("box-shadow", n),
...
function dropdownmenu(e, o, t, i) {
    ...
    (o = $("#dropmenudiv")).html(t.join("")),
    i && o.width(i);
    t = $(document).width() - 30,
    i = $(e).offset();
    return t - i.left < o.width() && (i.left = i.left - (o.width() - $(e).width())),
    o.css({
        left: i.left + "px",
...
function save_last_viewed(e) {
    ...
    return $.isArray(o) ? -1 == $.inArray(e, o) && (19 < o.length && o.pop(),
    o.unshift(e)) : (o = []).push(e),
    set_local_storage("viewed_ids", o),
    setcookie("viewed_ids", o.join()),
    !0
}
function hidemenu(e) {
...
jQuery(function(i) {
    ...
    i(document).keydown(function(e) {
        if (13 == e.which && e.ctrlKey) {
            var o;
            if (e.preventDefault(),
            window.getSelection ? o = window.getSelection() : document.getSelection ? o = document.getSelection() : document.selection && (o = document.selection.createRange().text),
            "" == o)
                return !1;
            if (255 < o.toString().length)
            ...
            e[dle_p_send] = function() {
                var e, o, t;
                i("#dle-promt-text").val().length < 1 ? i("#dle-promt-text").addClass("ui-state-error") : (e = i("#dle-promt-text").val(),
                o = i("#orfom").text(),
                t = "",
                i("#dle-promt-mail").val() && (t = i("#dle-promt-mail").val()),
                i(this).dialog("close"),
                i("#dlepopup").remove(),
                i.post(dle_root + "engine/ajax/controller.php?mod=complaint", {
                    seltext: o,
                    text: e,
                    mail: t,
                    user_hash: dle_login_hash,
            ...
            i("body").append("<div id='dlepopup' class='dle-promt' title='" + dle_c_title + "' style='display:none'>" + dle_orfo_title + "<br><textarea name='dle-promt-text' id='dle-promt-text' class='ui-widget-content ui-corner-all' style='width:100%;height:80px;'></textarea>" + n + "<div id='orfom' style='display:none'>" + o + "</div></div>"),
            i("#dlepopup").dialog({
                autoOpen: !0,
                width: 600,
                resizable: !1,
            ...
            i("#dlepopup").dialog("option", "position", {
                my: "center",
                at: "center",
                of: window
            })
